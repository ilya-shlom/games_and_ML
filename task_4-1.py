...
# Задание 4-1
print("Задание 4-1: Машинное обучение с подкреплением")
for i in range(5):
    print("Игра ", i + 1, ":", sep="")
    game(0.5, main_board)
    print("")
